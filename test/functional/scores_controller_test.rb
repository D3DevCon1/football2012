...
class ScoresControllerTest < ActionController::TestCase
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post :create, score: { away_score: @score.away_score, home_score: @score.home_score, result: @score.result }
    end
  ...
  test "should update score" do
    put :update, id: @score, score: { away_score: @score.away_score, home_score: @score.home_score, result: @score.result }
    assert_redirected_to score_path(assigns(:score))
  end
