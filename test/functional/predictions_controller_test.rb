...
class PredictionsControllerTest < ActionController::TestCase
  ...
  test "should create prediction" do
    assert_difference('Prediction.count') do
      post :create, prediction: { fixtures: @prediction.fixtures, gameweek_no: @prediction.gameweek_no, points: @prediction.points, user_id: @prediction.user_id }
    end
  ...
  test "should update prediction" do
    put :update, id: @prediction, prediction: { fixtures: @prediction.fixtures, gameweek_no: @prediction.gameweek_no, points: @prediction.points, user_id: @prediction.user_id }
    assert_redirected_to prediction_path(assigns(:prediction))
  end
